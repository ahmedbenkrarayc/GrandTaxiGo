...
<head>
    ...
    <title>Disponibilité | WSSlni</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen">
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <form id="disponibilityForm">
                    <div class="status-options">
                        <!-- Option 1: Disponible -->
                        <label class="status-option available" id="option-available">
                            <input type="radio" name="status" value="available" class="status-radio" checked>
                        ...
                        <label class="status-option busy" id="option-busy">
                            <input type="radio" name="status" value="busy" class="status-radio">
                            <div class="status-icon">
                        ...
                        <!-- Option 3: Indisponible -->
                        <label class="status-option unavailable" id="option-unavailable">
                            <input type="radio" name="status" value="unavailable" class="status-radio">
                            <div class="status-icon">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initially mark the first option as selected (assuming it's checked by default)
            document.getElementById('option-available').classList.add('selected');
            ...
            document.getElementById('disponibilityForm').addEventListener('submit', function(e) {
                e.preventDefault();
                ...
                alert('Statut mis à jour : ' + selectedStatus);
